...
activities = {
    ...
    "Basketball Club": {
        "description": "Open basketball sessions and pickup games for all skill levels",
    ...
    "Debate Team": {
        "description": "Practice public speaking, argumentation, and prepare for debate meets",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["sophia.d@mergington.edu", "matthew@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments, science fairs, and research projects",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["oliver@mergington.edu", "emma.l@mergington.edu"]
    }
}
